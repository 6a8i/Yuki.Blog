...
public class PostUseCaseTests
{
    ...
    private readonly PostUseCase _sut;

    public PostUseCaseTests()
    {
        _sut = new PostUseCase(_uow, _createPostValidator, _authorPorts, _postPorts);
    }

    [Fact]
    public async Task CreatePostAsync_WithValidCommandAndAuthorId_ShouldReturnSuccessWithPostId()
    {
        ...
        var result = await _sut.CreatePostAsync(command, CancellationToken.None);
    ...
    [Fact]
    public async Task CreatePostAsync_WithValidCommandAndAuthorName_ShouldReturnSuccessWithPostId()
    {
    ...
    [Fact]
    public async Task CreatePostAsync_WithAuthorNameAndAuthorNotFound_ShouldCreateAuthorAndPost()
    {
    ...
    [Fact]
    public async Task CreatePostAsync_WithAuthorIdAndAuthorNotFound_ShouldReturnFailure()
    {
    ...
    [Fact]
    public async Task CreatePostAsync_WithAuthorIdAndAuthorNotFound_ShouldNotCallAddAsync()
    {
        var authorId = Guid.NewGuid();
        var command = new CreatePostCommand("My Post", "Description", "Content", authorId, null, null);
        ...
        await _sut.CreatePostAsync(command, CancellationToken.None);

        await _postPorts.DidNotReceive().AddAsync(Arg.Any<Post>(), Arg.Any<CancellationToken>());
    }

    [Fact]
    public async Task CreatePostAsync_WithValidCommand_ShouldBeginTransactionAndCommit()
    {
        var command = new CreatePostCommand("My Post", "Description", "Content", Guid.NewGuid(), null, null);
        var author = new Author(command.AuthorId!.Value, "John", "Doe");
    ...
    [Fact]
    public async Task CreatePostAsync_WhenTitleIsEmpty_ShouldReturnValidationFailure()
    {
    ...
    [Fact]
    public async Task CreatePostAsync_WhenContentIsEmpty_ShouldReturnValidationFailure()
    {
    ...
    [Fact]
    public async Task CreatePostAsync_WhenNoAuthorIdentification_ShouldReturnValidationFailure()
    {
    ...
    [Fact]
    public async Task CreatePostAsync_WhenTitleExceedsMaxLength_ShouldReturnValidationFailure()
    {
    ...
    [Fact]
    public async Task CreatePostAsync_WhenDescriptionExceedsMaxLength_ShouldReturnValidationFailure()
    {
    ...
    [Fact]
    public async Task CreatePostAsync_WhenValidationFails_ShouldNotBeginTransaction()
    {
        var command = new CreatePostCommand("", "Description", "Content", Guid.NewGuid(), null, null);
    ...
    [Fact]
    public async Task CreatePostAsync_WhenAddAsyncThrowsException_ShouldRollbackAndReturnFailure()
    {
        var command = new CreatePostCommand("My Post", "Description", "Content", Guid.NewGuid(), null, null);
        var author = new Author(command.AuthorId!.Value, "John", "Doe");
    ...
    [Fact]
    public async Task CreatePostAsync_WithCancellationToken_ShouldPassTokenToPorts()
    {
        var command = new CreatePostCommand("My Post", "Description", "Content", Guid.NewGuid(), null, null);
        var author = new Author(command.AuthorId!.Value, "John", "Doe");
        ...
        await _sut.CreatePostAsync(command, token);
    ...
    [Fact]
    public async Task CreatePostAsync_WithExistingAuthorByName_ShouldNotCreateNewAuthor()
    {
